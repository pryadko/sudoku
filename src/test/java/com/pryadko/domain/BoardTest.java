    ...
    private static final Map<Integer, Integer[]> EXPECTED = new HashMap<Integer, Integer[]>() {
        {
            ...
            put(72, new Integer[]{0, 9, 18, 27, 36, 45, 54, 63, 72, 73, 74, 75, 76, 77, 78, 79, 80, 55, 56, 64, 65});
            put(39, new Integer[]{36, 37, 38, 39, 40, 41, 42, 43, 44, 3, 12, 21, 30, 48, 57, 66, 75, 31, 32, 49, 50});
            put(50, new Integer[]{5, 14, 23, 32, 41, 50, 59, 68, 77, 45, 46, 47, 48, 49, 51, 52, 53, 39, 40, 30, 31});
            put(5, new Integer[]{5, 14, 23, 32, 41, 50, 59, 68, 77, 0, 1, 2, 3, 4, 6, 7, 8, 12, 13, 21, 22});
            put(47, new Integer[]{2, 11, 20, 29, 38, 47, 56, 65, 74, 45, 46, 48, 49, 50, 51, 52, 53, 27, 28, 36, 37});
            put(68, new Integer[]{63, 64, 65, 66, 67, 68, 69, 70, 71, 77, 5, 14, 23, 32, 41, 50, 59, 57, 58, 75, 76});
            put(34, new Integer[]{27, 28, 29, 30, 31, 32, 33, 34, 35, 7, 16, 25, 43, 52, 61, 70, 79, 42, 51, 44, 53});
        }
    };
